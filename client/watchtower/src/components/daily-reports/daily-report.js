...
import { Upload, ChevronDown, ChevronRight, TrendingUp, TrendingDown, Home } from 'lucide-react';
        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl shadow-2xl p-12 text-center border border-slate-700">
            <div className="mb-6">
              ...
              <div className="text-slate-400 text-sm tracking-wider">STOCK ANALYSIS PLATFORM</div>
            </div>
            <Upload className="w-12 h-12 mx-auto mb-4 text-cyan-400" />
            <h1 className="text-2xl font-bold text-slate-200 mb-2">Upload Data</h1>
            <p className="text-slate-400 mb-6">Upload your CSV file to begin analysis</p>
