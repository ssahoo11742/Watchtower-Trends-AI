// src/pages/DailyReportPage.jsx - Mobile Optimized
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
        <div className="max-w-lg mx-auto mt-8">
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl shadow-2xl p-8 text-center border border-slate-700">
            <div className="mb-6">
              <div className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent mb-2">
                WATCHTOWER
              </div>
              <div className="text-slate-400 text-xs tracking-wider">STOCK ANALYSIS PLATFORM</div>
            </div>
            <Upload className="w-12 h-12 mx-auto mb-4 text-cyan-400" />
            <h1 className="text-xl font-bold text-slate-200 mb-2">Upload Data</h1>
